...
## Gameplay
- [ ] G1 Vehicle feel — raycast vehicle: grippy, forgiving, fun in 5s; chase cam with lag + speed-FOV; handbrake with particle puffs. AC: drive 10s scripted run, no flips on normal steering, avg fps ≥60 desktop tier.
...
- [ ] P1 Desktop 60fps — every pose ≥55 avg in headless (proxy), draw calls <200. AC: state() dumps.
